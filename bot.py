...
# 🔹 Configurazione della cartella media
MEDIA_FOLDER = "media"
...
# Caricamento dati esistenti (se disponibili)
try:
...
# 🔹 Frasi casuali per i messaggi
PHOTO_RESPONSES = ["🚀 Boom! Questa ti piacerà! 😎", "Ecco uno scatto speciale per te! 📸", "Guarda questa bellezza! 😍"]
VIDEO_RESPONSES = ["Goditi questo video! 🎥", "Guarda cosa ho trovato per te! 👀", "Un video che potrebbe piacerti! 🔥"]
...
# ✅ Funzione per gestire i file ricevuti
